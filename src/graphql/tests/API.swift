...
public struct ReviewInput: GraphQLMapConvertible {
  ...
  public init(
    stars: Int, commentary: Swift.Optional<String?> = nil,
    favoriteColor: Swift.Optional<ColorInput?> = nil
  ) {
  ...
  public var favoriteColor: Swift.Optional<ColorInput?> {
    get {
      return graphQLMap["favorite_color"] as? Swift.Optional<ColorInput?>
        ?? Swift.Optional<ColorInput?>.none
    }
    set {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "createReview",
          arguments: ["episode": GraphQLVariable("episode"), "review": GraphQLVariable("review")],
          type: .object(CreateReview.selections))
      ]
    }
    ...
    public init(createReview: CreateReview? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Mutation",
        "createReview": createReview.flatMap { (value: CreateReview) -> ResultMap in value.resultMap
        },
      ])
    }
    ...
    public var createReview: CreateReview? {
      get {
        return (resultMap["createReview"] as? ResultMap).flatMap {
          CreateReview(unsafeResultMap: $0)
        }
      }
      set {
    ...
    public struct CreateReview: GraphQLSelectionSet {
      ...
      public init(stars: Int, commentary: String? = nil) {
        self.init(unsafeResultMap: [
          "__typename": "Review", "stars": stars, "commentary": commentary,
        ])
      }
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "createReview",
          arguments: [
            "episode": "JEDI", "review": ["stars": 10, "commentary": "This is awesome!"],
          ], type: .object(CreateReview.selections))
      ]
    }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "createReview",
          arguments: ["episode": "JEDI", "review": ["stars": 10, "commentary": nil]],
          type: .object(CreateReview.selections))
      ]
    }
...
public final class HeroAndFriendsNamesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "hero", arguments: ["episode": GraphQLVariable("episode")], type: .object(Hero.selections)
        )
      ]
    }
    ...
    public init(hero: Hero? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Query",
        "hero": hero.flatMap { (value: Hero) -> ResultMap in value.resultMap },
      ])
    }
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static func makeHuman(name: String, friends: [Friend?]? = nil) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Human", "name": name,
          "friends": friends.flatMap { (value: [Friend?]) -> [ResultMap?] in
            value.map { (value: Friend?) -> ResultMap? in
              value.flatMap { (value: Friend) -> ResultMap in value.resultMap }
            }
          },
        ])
      }
      ...
      public var friends: [Friend?]? {
        get {
          return (resultMap["friends"] as? [ResultMap?]).flatMap {
            (value: [ResultMap?]) -> [Friend?] in
            value.map { (value: ResultMap?) -> Friend? in
              value.flatMap { (value: ResultMap) -> Friend in Friend(unsafeResultMap: value) }
            }
          }
        }
        set {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static func makeHuman(id: GraphQLID, name: String, friends: [Friend?]? = nil) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Human", "id": id, "name": name,
          "friends": friends.flatMap { (value: [Friend?]) -> [ResultMap?] in
            value.map { (value: Friend?) -> ResultMap? in
              value.flatMap { (value: Friend) -> ResultMap in value.resultMap }
            }
      ...
      public static func makeDroid(id: GraphQLID, name: String, friends: [Friend?]? = nil) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Droid", "id": id, "name": name,
          "friends": friends.flatMap { (value: [Friend?]) -> [ResultMap?] in
            value.map { (value: Friend?) -> ResultMap? in
              value.flatMap { (value: Friend) -> ResultMap in value.resultMap }
            }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static func makeDroid(friends: [AsDroid.Friend?]? = nil) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Droid",
          "friends": friends.flatMap { (value: [AsDroid.Friend?]) -> [ResultMap?] in
            value.map { (value: AsDroid.Friend?) -> ResultMap? in
              value.flatMap { (value: AsDroid.Friend) -> ResultMap in value.resultMap }
            }
          },
        ])
      }
      ...
      public static var selections: [GraphQLSelection] {
        return [
          ...
          GraphQLBooleanCondition(
            variableName: "skipName", inverted: true,
            selections: [
              GraphQLField("name", type: .nonNull(.scalar(String.self)))
            ]),
        ]
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLBooleanCondition(
            variableName: "includeName", inverted: false,
            selections: [
              GraphQLField("name", type: .nonNull(.scalar(String.self)))
            ]),
        ]
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLBooleanCondition(
            variableName: "includeDetails", inverted: false,
            selections: [
              GraphQLField("name", type: .nonNull(.scalar(String.self))),
              GraphQLField("appearsIn", type: .nonNull(.list(.scalar(Episode.self)))),
            ]),
...
public final class HeroDetailsFragmentConditionalInclusionQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static func makeHuman(id: GraphQLID? = nil, name: String? = nil, height: Double? = nil)
        -> Hero
      {
        return Hero(unsafeResultMap: [
          "__typename": "Human", "id": id, "name": name, "height": height,
        ])
      }

      public static func makeDroid(
        id: GraphQLID? = nil, name: String? = nil, primaryFunction: String? = nil
      ) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Droid", "id": id, "name": name, "primaryFunction": primaryFunction,
        ])
      }
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
          GraphQLBooleanCondition(
            variableName: "includeFriendsDetails", inverted: false,
            selections: [
              GraphQLField("friends", type: .list(.object(Friend.selections)))
            ]),
        ]
      ...
      public struct Friend: GraphQLSelectionSet {
        ...
        public static func makeDroid(name: String, primaryFunction: String? = nil) -> Friend {
          return Friend(unsafeResultMap: [
            "__typename": "Droid", "name": name, "primaryFunction": primaryFunction,
          ])
        }
...
public final class HeroDetailsQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static func makeHuman(id: GraphQLID, name: String, height: Double? = nil) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Human", "id": id, "name": name, "height": height,
        ])
      }

      public static func makeDroid(id: GraphQLID, name: String, primaryFunction: String? = nil)
        -> Hero
      {
        return Hero(unsafeResultMap: [
          "__typename": "Droid", "id": id, "name": name, "primaryFunction": primaryFunction,
      ...
      public struct AsHuman: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, name: String, height: Double? = nil) {
          self.init(unsafeResultMap: [
            "__typename": "Human", "id": id, "name": name, "height": height,
          ])
        }
      ...
      public struct AsDroid: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, name: String, primaryFunction: String? = nil) {
          self.init(unsafeResultMap: [
            "__typename": "Droid", "id": id, "name": name, "primaryFunction": primaryFunction,
          ])
        }
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public struct Fragments {
        ...
        public var droidDetails: DroidDetails? {
          get {
            if !DroidDetails.possibleTypes.contains(resultMap["__typename"]! as! String) {
              return nil
            }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Hero: GraphQLSelectionSet {
      ...
      public static func makeHuman(name: String, friends: [AsHuman.Friend?]? = nil) -> Hero {
        return Hero(unsafeResultMap: [
          "__typename": "Human", "name": name,
          "friends": friends.flatMap { (value: [AsHuman.Friend?]) -> [ResultMap?] in
            value.map { (value: AsHuman.Friend?) -> ResultMap? in
              value.flatMap { (value: AsHuman.Friend) -> ResultMap in value.resultMap }
            }
          },
        ])
      }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(hero: Hero? = nil, r2: R2? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Query",
        "hero": hero.flatMap { (value: Hero) -> ResultMap in value.resultMap },
        "r2": r2.flatMap { (value: R2) -> ResultMap in value.resultMap },
      ])
    }
...
public final class SearchQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "search", arguments: ["text": GraphQLVariable("term")],
          type: .list(.object(Search.selections)))
      ]
    }
    ...
    public init(search: [Search?]? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Query",
        "search": search.flatMap { (value: [Search?]) -> [ResultMap?] in
          value.map { (value: Search?) -> ResultMap? in
            value.flatMap { (value: Search) -> ResultMap in value.resultMap }
          }
        },
      ])
    }
    ...
    public var search: [Search?]? {
      get {
        return (resultMap["search"] as? [ResultMap?]).flatMap {
          (value: [ResultMap?]) -> [Search?] in
          value.map { (value: ResultMap?) -> Search? in
            value.flatMap { (value: ResultMap) -> Search in Search(unsafeResultMap: value) }
          }
        }
      }
      set {
    ...
    public struct Search: GraphQLSelectionSet {
      ...
      public static var selections: [GraphQLSelection] {
        return [
          GraphQLTypeCase(
            variants: [
              "Human": AsHuman.selections, "Droid": AsDroid.selections,
              "Starship": AsStarship.selections,
            ],
            default: [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self)))
            ]
...
public final class StarshipQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public init(starship: Starship? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Query",
        "starship": starship.flatMap { (value: Starship) -> ResultMap in value.resultMap },
      ])
    }
    ...
    public struct Starship: GraphQLSelectionSet {
      ...
      public init(name: String, coordinates: [[Double]]? = nil) {
        self.init(unsafeResultMap: [
          "__typename": "Starship", "name": name, "coordinates": coordinates,
        ])
      }
...
public final class StarshipCoordinatesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "starshipCoordinates", arguments: ["coordinates": GraphQLVariable("coordinates")],
          type: .object(StarshipCoordinate.selections))
      ]
    }
    ...
    public init(starshipCoordinates: StarshipCoordinate? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Query",
        "starshipCoordinates": starshipCoordinates.flatMap {
          (value: StarshipCoordinate) -> ResultMap in value.resultMap
        },
      ])
    }
    ...
    public var starshipCoordinates: StarshipCoordinate? {
      get {
        return (resultMap["starshipCoordinates"] as? ResultMap).flatMap {
          StarshipCoordinate(unsafeResultMap: $0)
        }
      }
      set {
    ...
    public struct StarshipCoordinate: GraphQLSelectionSet {
      ...
      public init(name: String, coordinates: [[Double]]? = nil, length: Double? = nil) {
        self.init(unsafeResultMap: [
          "__typename": "Starship", "name": name, "coordinates": coordinates, "length": length,
        ])
      }
...
public final class ReviewAddedSubscription: GraphQLSubscription {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField(
          "reviewAdded", arguments: ["episode": GraphQLVariable("episode")],
          type: .object(ReviewAdded.selections))
      ]
    }
    ...
    public init(reviewAdded: ReviewAdded? = nil) {
      self.init(unsafeResultMap: [
        ...
        "reviewAdded": reviewAdded.flatMap { (value: ReviewAdded) -> ResultMap in value.resultMap },
      ])
    }
    ...
    public struct ReviewAdded: GraphQLSelectionSet {
      ...
      public init(episode: Episode? = nil, stars: Int, commentary: String? = nil) {
        self.init(unsafeResultMap: [
          "__typename": "Review", "episode": episode, "stars": stars, "commentary": commentary,
        ])
      }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("hero", alias: "r2", type: .object(R2.selections)),
        GraphQLField(
          "hero", alias: "luke", arguments: ["episode": "EMPIRE"], type: .object(Luke.selections)),
      ]
    }
    ...
    public init(r2: R2? = nil, luke: Luke? = nil) {
      self.init(unsafeResultMap: [
        "__typename": "Query", "r2": r2.flatMap { (value: R2) -> ResultMap in value.resultMap },
        "luke": luke.flatMap { (value: Luke) -> ResultMap in value.resultMap },
      ])
    }
...
public struct CharacterNameAndDroidPrimaryFunction: GraphQLFragment {
  ...
  public static func makeHuman(name: String) -> CharacterNameAndDroidPrimaryFunction {
    return CharacterNameAndDroidPrimaryFunction(unsafeResultMap: [
      "__typename": "Human", "name": name,
    ])
  }

  public static func makeDroid(name: String, primaryFunction: String? = nil)
  ...
  public struct Fragments {
    ...
    public var droidPrimaryFunction: DroidPrimaryFunction? {
      get {
        if !DroidPrimaryFunction.possibleTypes.contains(resultMap["__typename"]! as! String) {
          return nil
        }
        return DroidPrimaryFunction(unsafeResultMap: resultMap)
      }
...
public struct CharacterNameAndDroidAppearsIn: GraphQLFragment {
  ...
  public static func makeDroid(name: String, appearsIn: [Episode?])
    -> CharacterNameAndDroidAppearsIn
  {
    return CharacterNameAndDroidAppearsIn(unsafeResultMap: [
      "__typename": "Droid", "name": name, "appearsIn": appearsIn,
    ])
  }
...
public struct HumanHeightWithVariable: GraphQLFragment {
  ...
  public static var selections: [GraphQLSelection] {
    return [
      GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
      GraphQLField(
        "height", arguments: ["unit": GraphQLVariable("heightUnit")], type: .scalar(Double.self)),
    ]
  }
...
public struct CharacterNameAndAppearsInWithNestedFragments: GraphQLFragment {
  ...
  public static func makeHuman(name: String, appearsIn: [Episode?])
    -> CharacterNameAndAppearsInWithNestedFragments
  {
    return CharacterNameAndAppearsInWithNestedFragments(unsafeResultMap: [
      "__typename": "Human", "name": name, "appearsIn": appearsIn,
    ])
  }
...
public struct CharacterNameWithNestedAppearsInFragment: GraphQLFragment {
  ...
  public static func makeHuman(name: String, appearsIn: [Episode?])
    -> CharacterNameWithNestedAppearsInFragment
  {
    return CharacterNameWithNestedAppearsInFragment(unsafeResultMap: [
      "__typename": "Human", "name": name, "appearsIn": appearsIn,
    ])
  }
...
public struct CharacterNameWithInlineFragment: GraphQLFragment {
  ...
  {
    return CharacterNameWithInlineFragment(unsafeResultMap: [
      "__typename": "Human",
      "friends": friends.flatMap { (value: [AsHuman.Friend?]) -> [ResultMap?] in
        value.map { (value: AsHuman.Friend?) -> ResultMap? in
          value.flatMap { (value: AsHuman.Friend) -> ResultMap in value.resultMap }
...
public struct FriendsNames: GraphQLFragment {
  ...
  public static func makeHuman(friends: [Friend?]? = nil) -> FriendsNames {
    return FriendsNames(unsafeResultMap: [
      "__typename": "Human",
      "friends": friends.flatMap { (value: [Friend?]) -> [ResultMap?] in
        value.map { (value: Friend?) -> ResultMap? in
          value.flatMap { (value: Friend) -> ResultMap in value.resultMap }
  ...
  public var friends: [Friend?]? {
    get {
      return (resultMap["friends"] as? [ResultMap?]).flatMap { (value: [ResultMap?]) -> [Friend?] in
        value.map { (value: ResultMap?) -> Friend? in
          value.flatMap { (value: ResultMap) -> Friend in Friend(unsafeResultMap: value) }
        }
      }
...
public struct HeroDetails: GraphQLFragment {
  ...
  public static func makeHuman(id: GraphQLID, name: String, height: Double? = nil) -> HeroDetails {
    return HeroDetails(unsafeResultMap: [
      "__typename": "Human", "id": id, "name": name, "height": height,
    ])
  }
  ...
  public struct AsHuman: GraphQLSelectionSet {
    ...
    public init(id: GraphQLID, name: String, height: Double? = nil) {
      self.init(unsafeResultMap: ["__typename": "Human", "id": id, "name": name, "height": height])
    }
...
public struct CharacterNameAndAppearsIn: GraphQLFragment {
  ...
  public static func makeHuman(name: String, appearsIn: [Episode?]) -> CharacterNameAndAppearsIn {
    return CharacterNameAndAppearsIn(unsafeResultMap: [
      "__typename": "Human", "name": name, "appearsIn": appearsIn,
    ])
  }
