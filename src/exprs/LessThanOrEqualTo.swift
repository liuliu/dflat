...
public struct LessThanOrEqualToExpr<L: Expr, R: Expr, Element>: Expr where L.ResultType == R.ResultType, L.ResultType: Comparable, L.Element == R.Element, L.Element == Element {
...
public func <= <L, R, Element: Atom>(left: L, right: R) -> LessThanOrEqualToExpr<L, R, Element> where L.ResultType == R.ResultType, L.ResultType: Comparable, L.Element == R.Element, L.Element == Element {
  return LessThanOrEqualToExpr(left: left, right: right)
}

public func <= <L, R, Element: Atom>(left: L, right: R) -> LessThanOrEqualToExpr<L, ValueExpr<R, Element>, Element> where L.ResultType == R, R: Comparable, L.Element == Element {
