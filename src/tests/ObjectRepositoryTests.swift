...
class ObjectRepositoryTests: XCTestCase {
  ...
  func testSetUpdatedObjects() {
    ...
    let monster1 = MyGame.Sample.Monster(pos: MyGame.Sample.Vec3(), name: "name1", inventory: [], weapons: [], equipped: nil, path: [])
    monster1._rowid = 1
    let monster2 = MyGame.Sample.Monster(pos: MyGame.Sample.Vec3(), name: "name2", inventory: [], weapons: [], equipped: nil, path: [])
    monster2._rowid = 2
