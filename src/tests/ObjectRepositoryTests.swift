...
class ObjectRepositoryTests: XCTestCase {
  ...
  func testSetUpdatedObjects() {
    ...
    let monster1 = MyGame.Sample.Monster(pos: nil, name: "name1", inventory: [], weapons: [], equipped: nil, path: [])
    monster1._rowid = 1
    let monster2 = MyGame.Sample.Monster(pos: nil, name: "name2", inventory: [], weapons: [], equipped: nil, path: [])
    monster2._rowid = 2
