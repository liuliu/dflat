...
extension MyGame.SampleV3 {
  ...
  public struct Vec3: Equatable, FlatBuffersDecodable {
    ...
    public static func from(byteBuffer bb: ByteBuffer) -> Self {
      ...
      Self(
        bb.read(
          def: zzz_DflatGen_MyGame_SampleV3_Vec3.self,
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        ...
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Vec3>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV3_Vec3.self)
        return true
      } catch {
        return false
      }
  ...
  public struct Empty: Equatable, FlatBuffersDecodable {
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        var bb = bb
        var verifier = try Verifier(buffer: &bb)
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Empty>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV3_Empty.self)
        return true
      } catch {
        return false
      }
  ...
  public struct Monster: Equatable, FlatBuffersDecodable {
    ...
    public init(_ obj: zzz_DflatGen_MyGame_SampleV3_Monster) {
      ...
      case .none_:
        self.equipped = nil
      case .weapon:
        self.equipped = obj.equipped(type: zzz_DflatGen_MyGame_SampleV3_Weapon.self).map {
          .weapon(Weapon($0))
        }
      case .orb:
        self.equipped = obj.equipped(type: zzz_DflatGen_MyGame_SampleV3_Orb.self).map {
          .orb(Orb($0))
        }
      case .empty:
        self.equipped = obj.equipped(type: zzz_DflatGen_MyGame_SampleV3_Empty.self).map {
          .empty(Empty($0))
        }
      }
      ...
      case .none_:
        self.wear = nil
      case .weapon:
        self.wear = obj.wear(type: zzz_DflatGen_MyGame_SampleV3_Weapon.self).map {
          .weapon(Weapon($0))
        }
      case .orb:
        self.wear = obj.wear(type: zzz_DflatGen_MyGame_SampleV3_Orb.self).map { .orb(Orb($0)) }
      case .empty:
        self.wear = obj.wear(type: zzz_DflatGen_MyGame_SampleV3_Empty.self).map {
          .empty(Empty($0))
        }
      }
    }
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        var bb = bb
        var verifier = try Verifier(buffer: &bb)
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Monster>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV3_Monster.self)
        return true
      } catch {
        return false
      }
  ...
  public struct Weapon: Equatable, FlatBuffersDecodable {
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        var bb = bb
        var verifier = try Verifier(buffer: &bb)
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Weapon>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV3_Weapon.self)
        return true
      } catch {
        return false
      }
  ...
  public struct Orb: Equatable, FlatBuffersDecodable {
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        var bb = bb
        var verifier = try Verifier(buffer: &bb)
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Orb>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV3_Orb.self)
        return true
      } catch {
        return false
      }
