...
extension MyGame.SampleV2.Monster {
  ...
  public struct pos {
    ...
    public static let x: FieldExpr<Float32, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f4__f0", primaryKey: false, hasIndex: false, tableReader: _tr__f4__f0,
      objectReader: _or__f4__f0)
    ...
    public static let y: FieldExpr<Float32, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f4__f4", primaryKey: false, hasIndex: false, tableReader: _tr__f4__f4,
      objectReader: _or__f4__f4)
    ...
    public static let z: FieldExpr<Float32, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f4__f8", primaryKey: false, hasIndex: false, tableReader: _tr__f4__f8,
      objectReader: _or__f4__f8)
  ...
  public static let mana: FieldExpr<Int16, MyGame.SampleV2.Monster> = FieldExpr(
  ...
  public static let hp: FieldExpr<Int16, MyGame.SampleV2.Monster> = FieldExpr(
    name: "f8", primaryKey: false, hasIndex: true, tableReader: _tr__f8, objectReader: _or__f8)
  ...
  public static let name: FieldExpr<String, MyGame.SampleV2.Monster> = FieldExpr(
    name: "__pk0", primaryKey: true, hasIndex: false, tableReader: _tr__f10, objectReader: _or__f10)
  ...
  public static let color: FieldExpr<MyGame.SampleV2.Color, MyGame.SampleV2.Monster> = FieldExpr(
    name: "__pk1", primaryKey: true, hasIndex: false, tableReader: _tr__f12, objectReader: _or__f12)

  public struct equipped {

    public static func match<T: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f26>(
      _ ofType: T.Type
    ) -> EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > {
      return ofType.zzz_match__Monster__f26
    }
    public static func `as`<T: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f26>(_ ofType: T.Type)
      -> T.zzz_AsType__Monster__f26.Type
    {
    ...
    public static let _type: FieldExpr<Int32, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f26__type", primaryKey: false, hasIndex: true, tableReader: _tr__f26__type,
  ...
  public struct wear {
    ...
    public static func match<T: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f34>(
      _ ofType: T.Type
    ) -> EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    ...
    public static func `as`<T: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f34>(_ ofType: T.Type)
      -> T.zzz_AsType__Monster__f34.Type
    {
    ...
    public static let _type: FieldExpr<Int32, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f34__type", primaryKey: false, hasIndex: false, tableReader: _tr__f34__type,
      objectReader: _or__f34__type)
...
public protocol zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f26 {
  ...
  static var zzz_match__Monster__f26:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    >
...
extension MyGame.SampleV2.Weapon: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f26 {
  public static let zzz_match__Monster__f26:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > = (MyGame.SampleV2.Monster.equipped._type == 1)

  public struct zzz_f26__Weapon {

    private static func _tr__f26__u1__f4(_ table: ByteBuffer) -> String? {
      let tr0 = zzz_DflatGen_MyGame_SampleV2_Monster.getRootAsMonster(bb: table)
      guard let tr1 = tr0.equipped(type: zzz_DflatGen_MyGame_SampleV2_Weapon.self) else {
        return nil
      }
    ...
    public static let name: FieldExpr<String, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f26__u1__f4", primaryKey: false, hasIndex: false, tableReader: _tr__f26__u1__f4,
      objectReader: _or__f26__u1__f4)
    ...
    public static let damage: FieldExpr<Int16, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f26__u1__f6", primaryKey: false, hasIndex: false, tableReader: _tr__f26__u1__f6,
      objectReader: _or__f26__u1__f6)
  }
...
extension MyGame.SampleV2.Orb: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f26 {
  public static let zzz_match__Monster__f26:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > = (MyGame.SampleV2.Monster.equipped._type == 2)
  ...
  public struct zzz_f26__Orb {
    ...
    public static let name: FieldExpr<String, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f26__u2__f4", primaryKey: false, hasIndex: true, tableReader: _tr__f26__u2__f4,
      objectReader: _or__f26__u2__f4)
    ...
    public static let color: FieldExpr<MyGame.SampleV2.Color, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f26__u2__f6", primaryKey: false, hasIndex: false, tableReader: _tr__f26__u2__f6,
      objectReader: _or__f26__u2__f6)
  }
...
extension MyGame.SampleV2.Empty: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f26 {
  public static let zzz_match__Monster__f26:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > = (MyGame.SampleV2.Monster.equipped._type == 3)
...
public protocol zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f34 {
  ...
  static var zzz_match__Monster__f34:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    >
...
extension MyGame.SampleV2.Weapon: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f34 {
  public static let zzz_match__Monster__f34:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > = (MyGame.SampleV2.Monster.wear._type == 1)
  ...
  public struct zzz_f34__Weapon {
    ...
    public static let name: FieldExpr<String, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f34__u1__f4", primaryKey: false, hasIndex: false, tableReader: _tr__f34__u1__f4,
      objectReader: _or__f34__u1__f4)
    ...
    public static let damage: FieldExpr<Int16, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f34__u1__f6", primaryKey: false, hasIndex: false, tableReader: _tr__f34__u1__f6,
      objectReader: _or__f34__u1__f6)
  }
...
extension MyGame.SampleV2.Orb: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f34 {
  public static let zzz_match__Monster__f34:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > = (MyGame.SampleV2.Monster.wear._type == 2)
  ...
  public struct zzz_f34__Orb {
    ...
    public static let name: FieldExpr<String, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f34__u2__f4", primaryKey: false, hasIndex: true, tableReader: _tr__f34__u2__f4,
      objectReader: _or__f34__u2__f4)
    ...
    public static let color: FieldExpr<MyGame.SampleV2.Color, MyGame.SampleV2.Monster> = FieldExpr(
      name: "f34__u2__f6", primaryKey: false, hasIndex: false, tableReader: _tr__f34__u2__f6,
      objectReader: _or__f34__u2__f6)
  }
...
extension MyGame.SampleV2.Empty: zzz_DflatGen_Proto__MyGame__SampleV2__Monster__f34 {
  public static let zzz_match__Monster__f34:
    EqualToExpr<
      FieldExpr<Int32, MyGame.SampleV2.Monster>, ValueExpr<Int32, MyGame.SampleV2.Monster>,
      MyGame.SampleV2.Monster
    > = (MyGame.SampleV2.Monster.wear._type == 3)
