  ...
  public struct Vec3: Equatable, FlatBuffersDecodable {
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        ...
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Vec3>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV2_Vec3.self)
        return true
      } catch {
        return false
      }
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        ...
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Empty>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV2_Empty.self)
        return true
      } catch {
        return false
      }
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        ...
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Weapon>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV2_Weapon.self)
        return true
      } catch {
        return false
      }
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        ...
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Orb>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV2_Orb.self)
        return true
      } catch {
        return false
      }
  ...
  public final class Monster: Dflat.Atom, SQLiteDflat.SQLiteAtom, FlatBuffersDecodable, Equatable {
    ...
    public static func verify(byteBuffer bb: ByteBuffer) -> Bool {
      do {
        var bb = bb
        var verifier = try Verifier(buffer: &bb)
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Monster>.verify(
          &verifier, at: 0, of: zzz_DflatGen_MyGame_SampleV2_Monster.self)
        return true
      } catch {
        return false
      }
