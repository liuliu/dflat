...
public final class Monster: Dflat.Atom, SQLiteDflat.SQLiteAtom, FlatBuffersDecodable, Equatable {
  ...
  public init(name: String, color: MyGame.SampleV2.Color, pos: MyGame.SampleV2.Vec3? = nil, mana: Int16? = 150, hp: Int16? = 100, inventory: [UInt8]? = [], weapons: [MyGame.SampleV2.Weapon]? = [], equipped: MyGame.SampleV2.Equipment? = nil, colors: [MyGame.SampleV2.Color]? = [], path: [MyGame.SampleV2.Vec3]? = [], wear: MyGame.SampleV2.Equipment? = nil) {
    self.pos = pos ?? nil
    self.mana = mana ?? 150
    self.hp = hp ?? 100
    self.name = name
  ...
  public static func setUpSchema(_ toolbox: PersistenceToolbox) {
    ...
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__samplev2__monster_v1_1 (rowid INTEGER PRIMARY KEY AUTOINCREMENT, __pk0 TEXT, __pk1 INTEGER, p BLOB, UNIQUE(__pk0, __pk1))", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__samplev2__monster_v1_1__f6 (rowid INTEGER PRIMARY KEY, f6 INTEGER)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE INDEX IF NOT EXISTS index__mygame__samplev2__monster_v1_1__f6 ON mygame__samplev2__monster_v1_1__f6 (f6)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__samplev2__monster_v1_1__f8 (rowid INTEGER PRIMARY KEY, f8 INTEGER)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE INDEX IF NOT EXISTS index__mygame__samplev2__monster_v1_1__f8 ON mygame__samplev2__monster_v1_1__f8 (f8)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__samplev2__monster_v1_1__f26__type (rowid INTEGER PRIMARY KEY, f26__type INTEGER)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE INDEX IF NOT EXISTS index__mygame__samplev2__monster_v1_1__f26__type ON mygame__samplev2__monster_v1_1__f26__type (f26__type)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__samplev2__monster_v1_1__f26__u2__f4 (rowid INTEGER PRIMARY KEY, f26__u2__f4 TEXT)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE UNIQUE INDEX IF NOT EXISTS index__mygame__samplev2__monster_v1_1__f26__u2__f4 ON mygame__samplev2__monster_v1_1__f26__u2__f4 (f26__u2__f4)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__samplev2__monster_v1_1__f34__u2__f4 (rowid INTEGER PRIMARY KEY, f34__u2__f4 TEXT)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE UNIQUE INDEX IF NOT EXISTS index__mygame__samplev2__monster_v1_1__f34__u2__f4 ON mygame__samplev2__monster_v1_1__f34__u2__f4 (f34__u2__f4)", nil, nil, nil)
  ...
  public static func insertIndex(_ toolbox: PersistenceToolbox, field: String, rowid: Int64, table: ByteBuffer) -> Bool {
    ...
    switch field {
    case "f6":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__samplev2__monster_v1_1__f6 (rowid, f6) VALUES (?1, ?2)") else { return false }
    ...
    case "f8":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__samplev2__monster_v1_1__f8 (rowid, f8) VALUES (?1, ?2)") else { return false }
      rowid.bindSQLite(insert, parameterId: 1)
      ...
      guard SQLITE_DONE == sqlite3_step(insert) else { return false }
    case "f26__type":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__samplev2__monster_v1_1__f26__type (rowid, f26__type) VALUES (?1, ?2)") else { return false }
      rowid.bindSQLite(insert, parameterId: 1)
      ...
      guard SQLITE_DONE == sqlite3_step(insert) else { return false }
    case "f26__u2__f4":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__samplev2__monster_v1_1__f26__u2__f4 (rowid, f26__u2__f4) VALUES (?1, ?2)") else { return false }
      rowid.bindSQLite(insert, parameterId: 1)
      ...
      guard SQLITE_DONE == sqlite3_step(insert) else { return false }
    case "f34__u2__f4":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__samplev2__monster_v1_1__f34__u2__f4 (rowid, f34__u2__f4) VALUES (?1, ?2)") else { return false }
      rowid.bindSQLite(insert, parameterId: 1)
