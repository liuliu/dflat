...
public enum zzz_DflatGen__MyGame__Sample__Monster {
public enum MyGame {
public enum Sample {
...
public struct Monster: FlatBufferObject {
    ...
    public var pos: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Vec3? { let o = _accessor.offset(VTOFFSET.pos.v); return o == 0 ? nil : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Vec3(_accessor.bb, o: o + _accessor.postion) }
    public var mana: Int16 { let o = _accessor.offset(VTOFFSET.mana.v); return o == 0 ? 150 : _accessor.readBuffer(of: Int16.self, at: o) }
    public var hp: Int16 { let o = _accessor.offset(VTOFFSET.hp.v); return o == 0 ? 100 : _accessor.readBuffer(of: Int16.self, at: o) }
    public var name: String? { let o = _accessor.offset(VTOFFSET.name.v); return o == 0 ? nil : _accessor.string(at: o) }
    public var nameSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.name.v) }
    public var color: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color { let o = _accessor.offset(VTOFFSET.color.v); return o == 0 ? .blue : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .blue }
    ...
    public func bagType(at index: Int32) -> zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment? { let o = _accessor.offset(VTOFFSET.bagType.v); return o == 0 ? zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment.none_ : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment(rawValue: _accessor.directRead(of: UInt8.self, offset: _accessor.vector(at: o) + index * 1)) }
    ...
    public func weapons(at index: Int32) -> zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Weapon? { let o = _accessor.offset(VTOFFSET.weapons.v); return o == 0 ? nil : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Weapon(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
    public var equippedType: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment { let o = _accessor.offset(VTOFFSET.equippedType.v); return o == 0 ? .none_ : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment(rawValue: _accessor.readBuffer(of: UInt8.self, at: o)) ?? .none_ }
    ...
    public func colors(at index: Int32) -> zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color? { let o = _accessor.offset(VTOFFSET.colors.v); return o == 0 ? zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color.red : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color(rawValue: _accessor.directRead(of: Int8.self, offset: _accessor.vector(at: o) + index * 1)) }
    public var pathCount: Int32 { let o = _accessor.offset(VTOFFSET.path.v); return o == 0 ? 0 : _accessor.vector(count: o) }
    public func path(at index: Int32) -> zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Vec3? { let o = _accessor.offset(VTOFFSET.path.v); return o == 0 ? nil : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Vec3(_accessor.bb, o: _accessor.vector(at: o) + index * 12) }
    public static func startMonster(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
    public static func add(pos: UnsafeMutableRawPointer?, _ fbb: inout FlatBufferBuilder) { guard let pos = pos else { return }; fbb.create(struct: pos, type: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Vec3.self); fbb.add(structOffset: VTOFFSET.pos.p) }
    ...
    public static func add(color: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color, _ fbb: inout FlatBufferBuilder) { fbb.add(element: color.rawValue, def: 2, at: VTOFFSET.color.p) }
    ...
    public static func add(equippedType: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment, _ fbb: inout FlatBufferBuilder) { fbb.add(element: equippedType.rawValue, def: 0, at: VTOFFSET.equippedType.p) }
    ...
    color: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color = .blue,
    ...
    equippedType: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Equipment = .none_,
...
public struct Orb: FlatBufferObject {
    ...
    public var name: String? { let o = _accessor.offset(VTOFFSET.name.v); return o == 0 ? nil : _accessor.string(at: o) }
    public var nameSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.name.v) }
    public var color: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color { let o = _accessor.offset(VTOFFSET.color.v); return o == 0 ? .red : zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .red }
    public static func startOrb(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
    public static func add(name: Offset<String>, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: name, at: VTOFFSET.name.p)  }
    public static func add(color: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color, _ fbb: inout FlatBufferBuilder) { fbb.add(element: color.rawValue, def: 0, at: VTOFFSET.color.p) }
    ...
    offsetOfName name: Offset<String> = Offset(),
    color: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Color = .red) -> Offset<UOffset> {
...
// MARK: - zzz_DflatGen__MyGame__Sample__Monster
