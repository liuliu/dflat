...
public struct Monster: FlatBufferObject {
    ...
    public func bagType(at index: Int32) -> FlatBuffers_Generated.MyGame.Sample.Equipment? { let o = _accessor.offset(VTOFFSET.bagType.v); return o == 0 ? FlatBuffers_Generated.MyGame.Sample.Equipment.none_ : FlatBuffers_Generated.MyGame.Sample.Equipment(rawValue: _accessor.directRead(of: UInt8.self, offset: _accessor.vector(at: o) + index * 1)) }
...
public struct Orb: FlatBufferObject {
    ...
    public var name: String? { let o = _accessor.offset(VTOFFSET.name.v); return o == 0 ? nil : _accessor.string(at: o) }
    public var nameSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.name.v) }
    public var color: FlatBuffers_Generated.MyGame.Sample.Color { let o = _accessor.offset(VTOFFSET.color.v); return o == 0 ? .red : FlatBuffers_Generated.MyGame.Sample.Color(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .red }
    public static func startOrb(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
    public static func add(name: Offset<String>, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: name, at: VTOFFSET.name.p)  }
    public static func add(color: FlatBuffers_Generated.MyGame.Sample.Color, _ fbb: inout FlatBufferBuilder) { fbb.add(element: color.rawValue, def: 0, at: VTOFFSET.color.p) }
    ...
    offsetOfName name: Offset<String> = Offset(),
    color: FlatBuffers_Generated.MyGame.Sample.Color = .red) -> Offset<UOffset> {
