...
public final class Monster: Dflat.Atom, SQLiteDflat.SQLiteAtom, FlatBuffersDecodable, Equatable {
  ...
  public init(name: String, color: MyGame.Sample.Color, pos: MyGame.Sample.Vec3? = nil, mana: Int16? = 150, hp: Int16? = 100, inventory: [UInt8]? = [], bag: [MyGame.Sample.Equipment]? = [], weapons: [MyGame.Sample.Weapon]? = [], equipped: MyGame.Sample.Equipment? = nil, colors: [MyGame.Sample.Color]? = [], path: [MyGame.Sample.Vec3]? = [], hpOld: Int16? = 200, profile: MyGame.Sample.Profile? = nil, type: Bool? = false, truth: Bool? = true) {
    self.pos = pos ?? nil
    self.mana = mana ?? 150
    self.hp = hp ?? 100
    self.name = name
  ...
  public static func setUpSchema(_ toolbox: PersistenceToolbox) {
    ...
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__sample__monster_v1_1 (rowid INTEGER PRIMARY KEY AUTOINCREMENT, __pk0 TEXT, __pk1 INTEGER, p BLOB, UNIQUE(__pk0, __pk1))", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__sample__monster_v1_1__f6 (rowid INTEGER PRIMARY KEY, f6 INTEGER)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE INDEX IF NOT EXISTS index__mygame__sample__monster_v1_1__f6 ON mygame__sample__monster_v1_1__f6 (f6)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__sample__monster_v1_1__f26__type (rowid INTEGER PRIMARY KEY, f26__type INTEGER)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE INDEX IF NOT EXISTS index__mygame__sample__monster_v1_1__f26__type ON mygame__sample__monster_v1_1__f26__type (f26__type)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE TABLE IF NOT EXISTS mygame__sample__monster_v1_1__f26__u2__f4 (rowid INTEGER PRIMARY KEY, f26__u2__f4 TEXT)", nil, nil, nil)
    sqlite3_exec(sqlite.sqlite, "CREATE UNIQUE INDEX IF NOT EXISTS index__mygame__sample__monster_v1_1__f26__u2__f4 ON mygame__sample__monster_v1_1__f26__u2__f4 (f26__u2__f4)", nil, nil, nil)
  ...
  public static func insertIndex(_ toolbox: PersistenceToolbox, field: String, rowid: Int64, table: ByteBuffer) -> Bool {
    ...
    switch field {
    case "f6":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__sample__monster_v1_1__f6 (rowid, f6) VALUES (?1, ?2)") else { return false }
    ...
    case "f26__type":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__sample__monster_v1_1__f26__type (rowid, f26__type) VALUES (?1, ?2)") else { return false }
      rowid.bindSQLite(insert, parameterId: 1)
      ...
      guard SQLITE_DONE == sqlite3_step(insert) else { return false }
    case "f26__u2__f4":
      guard let insert = sqlite.prepareStaticStatement("INSERT INTO mygame__sample__monster_v1_1__f26__u2__f4 (rowid, f26__u2__f4) VALUES (?1, ?2)") else { return false }
      rowid.bindSQLite(insert, parameterId: 1)
