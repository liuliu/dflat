...
extension MyGame.Sample.Equipment {
  ...
  var _type: DflatGen__MyGame__Sample.MyGame.Sample.Equipment {
    switch self {
    case .weapon(_):
      return DflatGen__MyGame__Sample.MyGame.Sample.Equipment.weapon
    case .orb(_):
      return DflatGen__MyGame__Sample.MyGame.Sample.Equipment.orb
    }
  }
}
...
extension MyGame.Sample.Vec3 {
  func toRawMemory() -> UnsafeMutableRawPointer {
    return DflatGen__MyGame__Sample.MyGame.Sample.createVec3(x: self.x, y: self.y, z: self.z)
  }
}
...
extension MyGame.Sample.Weapon {
  func to(flatBufferBuilder: inout FlatBufferBuilder) -> Offset<UOffset> {
    ...
    return DflatGen__MyGame__Sample.MyGame.Sample.Weapon.createWeapon(&flatBufferBuilder, offsetOfName: __name, damage: self.damage)
  }
}
...
extension MyGame.Sample.Orb {
  func to(flatBufferBuilder: inout FlatBufferBuilder) -> Offset<UOffset> {
    let __name = self.name.map { flatBufferBuilder.create(string: $0) } ?? Offset<String>()
    let __color = DflatGen__MyGame__Sample.MyGame.Sample.Color(rawValue: self.color.rawValue) ?? .red
    return DflatGen__MyGame__Sample.MyGame.Sample.Orb.createOrb(&flatBufferBuilder, offsetOfName: __name, color: __color)
  }
}
...
extension MyGame.Sample.Monster {
  func to(flatBufferBuilder: inout FlatBufferBuilder) -> Offset<UOffset> {
    ...
    let __color = DflatGen__MyGame__Sample.MyGame.Sample.Color(rawValue: self.color.rawValue) ?? .blue
    let __inventory = flatBufferBuilder.createVector(self.inventory)
    var __bagType = [DflatGen__MyGame__Sample.MyGame.Sample.Equipment]()
    for i in self.bag {
    ...
    var __colors = [DflatGen__MyGame__Sample.MyGame.Sample.Color]()
    for i in self.colors {
      __colors.append(DflatGen__MyGame__Sample.MyGame.Sample.Color(rawValue: i.rawValue) ?? .red)
    }
