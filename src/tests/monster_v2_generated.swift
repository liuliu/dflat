...
public struct zzz_DflatGen_MyGame_SampleV2_Monster: FlatBufferObject, Verifiable {
  ...
  public var pos: zzz_DflatGen_MyGame_SampleV2_Vec3? { let o = _accessor.offset(VTOFFSET.pos.v); return o == 0 ? nil : _accessor.readBuffer(of: zzz_DflatGen_MyGame_SampleV2_Vec3.self, at: o) }
  public var mutablePos: zzz_DflatGen_MyGame_SampleV2_Vec3_Mutable? { let o = _accessor.offset(VTOFFSET.pos.v); return o == 0 ? nil : zzz_DflatGen_MyGame_SampleV2_Vec3_Mutable(_accessor.bb, o: o + _accessor.postion) }
  ...
  public func path(at index: Int32) -> zzz_DflatGen_MyGame_SampleV2_Vec3? { let o = _accessor.offset(VTOFFSET.path.v); return o == 0 ? nil : _accessor.directRead(of: zzz_DflatGen_MyGame_SampleV2_Vec3.self, offset: _accessor.vector(at: o) + index * 12) }
  public func mutablePath(at index: Int32) -> zzz_DflatGen_MyGame_SampleV2_Vec3_Mutable? { let o = _accessor.offset(VTOFFSET.path.v); return o == 0 ? nil : zzz_DflatGen_MyGame_SampleV2_Vec3_Mutable(_accessor.bb, o: _accessor.vector(at: o) + index * 12) }
  ...
  public static func add(pos: zzz_DflatGen_MyGame_SampleV2_Vec3?, _ fbb: inout FlatBufferBuilder) { guard let pos = pos else { return }; fbb.create(struct: pos, position: VTOFFSET.pos.p) }
  ...
  public static func startVectorOfPath(_ size: Int, in builder: inout FlatBufferBuilder) {
    builder.startVector(size * MemoryLayout<zzz_DflatGen_MyGame_SampleV2_Vec3>.size, elementSize: MemoryLayout<zzz_DflatGen_MyGame_SampleV2_Vec3>.alignment)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.pos.p, fieldName: "pos", required: false, type: zzz_DflatGen_MyGame_SampleV2_Vec3.self)
    ...
    try _v.visit(field: VTOFFSET.color.p, fieldName: "color", required: false, type: zzz_DflatGen_MyGame_SampleV2_Color.self)
    try _v.visit(field: VTOFFSET.inventory.p, fieldName: "inventory", required: false, type: ForwardOffset<Vector<UInt8, UInt8>>.self)
    try _v.visit(field: VTOFFSET.weapons.p, fieldName: "weapons", required: false, type: ForwardOffset<Vector<ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Weapon>, zzz_DflatGen_MyGame_SampleV2_Weapon>>.self)
    try _v.visit(unionKey: VTOFFSET.equippedType.p, unionField: VTOFFSET.equipped.p, unionKeyName: "equippedType", fieldName: "equipped", required: false, completion: { (verifier, key: zzz_DflatGen_MyGame_SampleV2_Equipment, pos) in
      switch key {
      case .none_:
        break // NOTE - SWIFT doesnt support none
      case .weapon:
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Weapon>.verify(&verifier, at: pos, of: zzz_DflatGen_MyGame_SampleV2_Weapon.self)
      case .orb:
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Orb>.verify(&verifier, at: pos, of: zzz_DflatGen_MyGame_SampleV2_Orb.self)
      case .empty:
        try ForwardOffset<zzz_DflatGen_MyGame_SampleV2_Empty>.verify(&verifier, at: pos, of: zzz_DflatGen_MyGame_SampleV2_Empty.self)
      }
    })
    try _v.visit(field: VTOFFSET.colors.p, fieldName: "colors", required: false, type: ForwardOffset<Vector<zzz_DflatGen_MyGame_SampleV2_Color, zzz_DflatGen_MyGame_SampleV2_Color>>.self)
    try _v.visit(field: VTOFFSET.path.p, fieldName: "path", required: false, type: ForwardOffset<Vector<zzz_DflatGen_MyGame_SampleV2_Vec3, zzz_DflatGen_MyGame_SampleV2_Vec3>>.self)
    try _v.visit(unionKey: VTOFFSET.wearType.p, unionField: VTOFFSET.wear.p, unionKeyName: "wearType", fieldName: "wear", required: false, completion: { (verifier, key: zzz_DflatGen_MyGame_SampleV2_Equipment, pos) in
      switch key {
      case .none_:
        break // NOTE - SWIFT doesnt support none
      case .weapon:
