...
extension zzz_DflatGen_MyGame_SampleV2_Vec3 {
    public static func createVec3(x: Float32 = 0.0, y: Float32 = 0.0, z: Float32 = 0.0) -> UnsafeMutableRawPointer {
        let memory = UnsafeMutableRawPointer.allocate(byteCount: zzz_DflatGen_MyGame_SampleV2_Vec3.size, alignment: zzz_DflatGen_MyGame_SampleV2_Vec3.alignment)
        memory.initializeMemory(as: UInt8.self, repeating: 0, count: zzz_DflatGen_MyGame_SampleV2_Vec3.size)
...
public struct zzz_DflatGen_MyGame_SampleV2_Monster: FlatBufferObject {
    ...
    public static func add(pos: UnsafeMutableRawPointer?, _ fbb: inout FlatBufferBuilder) { guard let pos = pos else { return }; fbb.create(struct: pos, type: zzz_DflatGen_MyGame_SampleV2_Vec3.self); fbb.add(structOffset: VTOFFSET.pos.p) }
