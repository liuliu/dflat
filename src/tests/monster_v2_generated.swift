...
extension zzz_DflatGen_MyGame_SampleV2_Vec3 {
  ...
  public static func createVec3(
    ...
    builder.createStructOf(
      size: zzz_DflatGen_MyGame_SampleV2_Vec3.size,
      alignment: zzz_DflatGen_MyGame_SampleV2_Vec3.alignment)
...
public struct zzz_DflatGen_MyGame_SampleV2_Monster: FlatBufferObject {
  ...
  public var pos: zzz_DflatGen_MyGame_SampleV2_Vec3? {
    ...
    return o == 0 ? nil : zzz_DflatGen_MyGame_SampleV2_Vec3(_accessor.bb, o: o + _accessor.postion)
  }
  ...
  public func path(at index: Int32) -> zzz_DflatGen_MyGame_SampleV2_Vec3? {
    ...
    return o == 0
      ? nil
      : zzz_DflatGen_MyGame_SampleV2_Vec3(_accessor.bb, o: _accessor.vector(at: o) + index * 12)
  }
  ...
  public static func startVectorOfPath(_ size: Int, in builder: inout FlatBufferBuilder) {
    builder.startVectorOfStructs(
      count: size, size: zzz_DflatGen_MyGame_SampleV2_Vec3.size,
      alignment: zzz_DflatGen_MyGame_SampleV2_Vec3.alignment)
  }
  public static func add(
