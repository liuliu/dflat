...
extension MyGame.Sample.Weapon: zzz_DflatGen_Proto__MyGame__Sample__Monster__f26 {
  ...
  private static func _tr__f26__u1__f4(_ table: ByteBuffer) -> String? {
    let tr0 = zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Monster.getRootAsMonster(bb: table)
    guard let tr1 = tr0.equipped(type: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Weapon.self) else { return nil }
...
extension MyGame.Sample.Orb: zzz_DflatGen_Proto__MyGame__Sample__Monster__f26 {
  ...
  private static func _tr__f26__u2__f4(_ table: ByteBuffer) -> String? {
    let tr0 = zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Monster.getRootAsMonster(bb: table)
    guard let tr1 = tr0.equipped(type: zzz_DflatGen__MyGame__Sample__Monster.MyGame.Sample.Orb.self) else { return nil }
    guard let s = tr1.name else { return nil }
    return s
  }
