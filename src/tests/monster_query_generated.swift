...
extension MyGame.Sample.Monster {
  ...
  public struct pos {
    ...
    public static let x: FieldExpr<Float32, MyGame.Sample.Monster> = FieldExpr(
    ...
    public static let y: FieldExpr<Float32, MyGame.Sample.Monster> = FieldExpr(
    ...
    public static let z: FieldExpr<Float32, MyGame.Sample.Monster> = FieldExpr(
  ...
  public static let mana: FieldExpr<Int16, MyGame.Sample.Monster> = FieldExpr(
  ...
  public static let hp: FieldExpr<Int16, MyGame.Sample.Monster> = FieldExpr(
  ...
  public static let name: FieldExpr<String, MyGame.Sample.Monster> = FieldExpr(
  ...
  public static let color: FieldExpr<MyGame.Sample.Color, MyGame.Sample.Monster> = FieldExpr(
    name: "__pk1", primaryKey: true, hasIndex: false, tableReader: _tr__f12, objectReader: _or__f12)

  public struct equipped {

    public static func match<T: zzz_DflatGen_Proto__MyGame__Sample__Monster__f26>(_ ofType: T.Type)
      -> EqualToExpr<
        FieldExpr<Int32, MyGame.Sample.Monster>, ValueExpr<Int32, MyGame.Sample.Monster>,
        MyGame.Sample.Monster
      >
    {
      return ofType.zzz_match__Monster__f26
    }
    public static func `as`<T: zzz_DflatGen_Proto__MyGame__Sample__Monster__f26>(_ ofType: T.Type)
    ...
    public static let _type: FieldExpr<Int32, MyGame.Sample.Monster> = FieldExpr(
  ...
  public struct profile {
    ...
    private static func _tr__f34__f4(_ table: ByteBuffer) -> String? {
      let tr0 = zzz_DflatGen_MyGame_Sample_Monster.getRootAsMonster(bb: table)
      guard let tr1 = tr0.profile else { return nil }
      guard let s = tr1.url else { return nil }
      return s
    }
    private static func _or__f34__f4(_ or0: MyGame.Sample.Monster) -> String? {
      guard let or1 = or0.profile else { return nil }
      guard let s = or1.url else { return nil }
      return s
    }
    public static let url: FieldExpr<String, MyGame.Sample.Monster> = FieldExpr(
      name: "f34__f4", primaryKey: false, hasIndex: false, tableReader: _tr__f34__f4,
      objectReader: _or__f34__f4)
  ...
  public static let type: FieldExpr<Bool, MyGame.Sample.Monster> = FieldExpr(
    name: "f36", primaryKey: false, hasIndex: false, tableReader: _tr__f36, objectReader: _or__f36)

  private static func _tr__f38(_ table: ByteBuffer) -> Bool? {
    let tr0 = zzz_DflatGen_MyGame_Sample_Monster.getRootAsMonster(bb: table)
    return tr0.truth
  }
  private static func _or__f38(_ or0: MyGame.Sample.Monster) -> Bool? {
    return or0.truth
  }
  public static let truth: FieldExpr<Bool, MyGame.Sample.Monster> = FieldExpr(
...
extension MyGame.Sample.Weapon: zzz_DflatGen_Proto__MyGame__Sample__Monster__f26 {
  public static let zzz_match__Monster__f26:
    EqualToExpr<
      FieldExpr<Int32, MyGame.Sample.Monster>, ValueExpr<Int32, MyGame.Sample.Monster>,
      MyGame.Sample.Monster
    > = (MyGame.Sample.Monster.equipped._type == 1)
  ...
  public struct zzz_f26__Weapon {
    ...
    public static let damage: FieldExpr<Int16, MyGame.Sample.Monster> = FieldExpr(
...
extension MyGame.Sample.Orb: zzz_DflatGen_Proto__MyGame__Sample__Monster__f26 {
  public static let zzz_match__Monster__f26:
    EqualToExpr<
      FieldExpr<Int32, MyGame.Sample.Monster>, ValueExpr<Int32, MyGame.Sample.Monster>,
      MyGame.Sample.Monster
    > = (MyGame.Sample.Monster.equipped._type == 2)
