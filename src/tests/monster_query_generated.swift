...
public extension MyGame.Sample.Monster {
  ...
  static let hpOld: FieldExpr<Int16, MyGame.Sample.Monster> = FieldExpr(name: "f32", primaryKey: false, hasIndex: false, tableReader: _tr__f32, objectReader: _or__f32)
  ...
  static let truth: FieldExpr<Bool, MyGame.Sample.Monster> = FieldExpr(name: "f38", primaryKey: false, hasIndex: false, tableReader: _tr__f38, objectReader: _or__f38)
}
