...
public struct zzz_DflatGen_MyGame_SampleV3_Monster: FlatBufferObject, Verifiable {
  ...
  where T: Verifiable {
    ...
    try _v.visit(
      ...
      type: zzz_DflatGen_MyGame_SampleV3_Vec3.self)
    ...
    try _v.visit(
      ...
      type: zzz_DflatGen_MyGame_SampleV3_Color.self)
    try _v.visit(
    ...
    try _v.visit(
      ...
      type: ForwardOffset<
        Vector<
          ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Weapon>, zzz_DflatGen_MyGame_SampleV3_Weapon
        >
      >.self)
    try _v.visit(
      ...
      completion: { (verifier, key: zzz_DflatGen_MyGame_SampleV3_Equipment, pos) in
        switch key {
        case .none_:
          break  // NOTE - SWIFT doesnt support none
        case .weapon:
          try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Weapon>.verify(
            &verifier, at: pos, of: zzz_DflatGen_MyGame_SampleV3_Weapon.self)
        case .orb:
          try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Orb>.verify(
            &verifier, at: pos, of: zzz_DflatGen_MyGame_SampleV3_Orb.self)
        case .empty:
          try ForwardOffset<zzz_DflatGen_MyGame_SampleV3_Empty>.verify(
            &verifier, at: pos, of: zzz_DflatGen_MyGame_SampleV3_Empty.self)
        }
      })
    try _v.visit(
      field: VTOFFSET.colors.p, fieldName: "colors", required: false,
      type: ForwardOffset<
        Vector<zzz_DflatGen_MyGame_SampleV3_Color, zzz_DflatGen_MyGame_SampleV3_Color>
      >.self)
    try _v.visit(
      field: VTOFFSET.path.p, fieldName: "path", required: false,
      type: ForwardOffset<
        Vector<zzz_DflatGen_MyGame_SampleV3_Vec3, zzz_DflatGen_MyGame_SampleV3_Vec3>
      >.self)
    try _v.visit(
