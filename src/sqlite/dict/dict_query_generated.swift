...
extension DictItem {
  ...
  private static func _tr__f8(_ table: ByteBuffer) -> String? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    guard let s = tr0.version else { return nil }
    return s
  }
  private static func _or__f8(_ or0: DictItem) -> String? {
    guard let s = or0.version else { return nil }
    return s
  }
  public static let version: FieldExpr<String, DictItem> = FieldExpr(
    name: "f8", primaryKey: false, hasIndex: false, tableReader: _tr__f8, objectReader: _or__f8)

  private static func _tr__f10(_ table: ByteBuffer) -> ValueType? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    return ValueType(rawValue: tr0.valueType.rawValue)!
  }
  private static func _or__f10(_ or0: DictItem) -> ValueType? {
  ...
  private static func _tr__f12(_ table: ByteBuffer) -> Bool? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    return tr0.boolValue
  }
  private static func _or__f12(_ or0: DictItem) -> Bool? {
  ...
  private static func _tr__f14(_ table: ByteBuffer) -> Int64? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    return tr0.longValue
  }
  private static func _or__f14(_ or0: DictItem) -> Int64? {
  ...
  private static func _tr__f16(_ table: ByteBuffer) -> UInt64? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    return tr0.unsignedLongValue
  }
  private static func _or__f16(_ or0: DictItem) -> UInt64? {
  ...
  private static func _tr__f18(_ table: ByteBuffer) -> Float32? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    return tr0.floatValue
  }
  private static func _or__f18(_ or0: DictItem) -> Float32? {
  ...
  private static func _tr__f20(_ table: ByteBuffer) -> Double? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    return tr0.doubleValue
  }
  private static func _or__f20(_ or0: DictItem) -> Double? {
  ...
  private static func _tr__f22(_ table: ByteBuffer) -> String? {
    let tr0 = zzz_DflatGen_DictItem.getRootAsDictItem(bb: table)
    guard let s = tr0.stringValue else { return nil }
    return s
  }
  private static func _or__f22(_ or0: DictItem) -> String? {
