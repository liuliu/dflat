...
public enum zzz_DflatGen_ValueType: Int8, Enum {
...
public struct zzz_DflatGen_DictItem: FlatBufferObject {
  ...
  public static func add(stringValue: Offset<String>, _ fbb: inout FlatBufferBuilder) {
    fbb.add(offset: stringValue, at: VTOFFSET.stringValue.p)
  }
  public static func addVectorOf(codable: Offset<UOffset>, _ fbb: inout FlatBufferBuilder) {
    fbb.add(offset: codable, at: VTOFFSET.codable.p)
  }
  public static func endDictItem(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset<UOffset>
  {
  ...
  public static func createDictItem(
    ...
    stringValueOffset stringValue: Offset<String> = Offset(),
    codableVectorOffset codable: Offset<UOffset> = Offset()
  ) -> Offset<UOffset> {
