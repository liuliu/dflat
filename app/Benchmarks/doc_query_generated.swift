...
extension BenchDoc {
  ...
  public struct pos {
    ...
    public static let x: FieldExpr<Float32, BenchDoc> = FieldExpr(
    ...
    public static let y: FieldExpr<Float32, BenchDoc> = FieldExpr(
    ...
    public static let z: FieldExpr<Float32, BenchDoc> = FieldExpr(
  ...
  public static let color: FieldExpr<Color, BenchDoc> = FieldExpr(
  ...
  public static let title: FieldExpr<String, BenchDoc> = FieldExpr(
    name: "__pk0", primaryKey: true, hasIndex: false, tableReader: _tr__f8, objectReader: _or__f8)

  public struct content {

    public static func match<T: zzz_DflatGen_Proto__BenchDoc__f12>(_ ofType: T.Type) -> EqualToExpr<
      FieldExpr<Int32, BenchDoc>, ValueExpr<Int32, BenchDoc>, BenchDoc
    > {
      return ofType.zzz_match__BenchDoc__f12
    }
    public static func `as`<T: zzz_DflatGen_Proto__BenchDoc__f12>(_ ofType: T.Type) -> T
      .zzz_AsType__BenchDoc__f12.Type
    {
    ...
    public static let _type: FieldExpr<Int32, BenchDoc> = FieldExpr(
      name: "f12__type", primaryKey: false, hasIndex: false, tableReader: _tr__f12__type,
      objectReader: _or__f12__type)
  ...
  public static let tag: FieldExpr<String, BenchDoc> = FieldExpr(
  ...
  public static let priority: FieldExpr<Int32, BenchDoc> = FieldExpr(
...
public protocol zzz_DflatGen_Proto__BenchDoc__f12 {
  ...
  static var zzz_match__BenchDoc__f12:
    EqualToExpr<FieldExpr<Int32, BenchDoc>, ValueExpr<Int32, BenchDoc>, BenchDoc>
  { get }
}

extension TextContent: zzz_DflatGen_Proto__BenchDoc__f12 {
  public static let zzz_match__BenchDoc__f12:
    EqualToExpr<FieldExpr<Int32, BenchDoc>, ValueExpr<Int32, BenchDoc>, BenchDoc> =
      (BenchDoc.content._type == 1)
  ...
  public struct zzz_f12__TextContent {
    ...
    public static let text: FieldExpr<String, BenchDoc> = FieldExpr(
      name: "f12__u1__f4", primaryKey: false, hasIndex: false, tableReader: _tr__f12__u1__f4,
      objectReader: _or__f12__u1__f4)
  }
