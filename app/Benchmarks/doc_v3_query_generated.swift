...
extension BenchDocV3 {
  ...
  public static let title: FieldExpr<String, BenchDocV3> = FieldExpr(
  ...
  public static let tag: FieldExpr<String, BenchDocV3> = FieldExpr(
  ...
  public static let priority: FieldExpr<Int32, BenchDocV3> = FieldExpr(
  ...
  public static let text: FieldExpr<String, BenchDocV3> = FieldExpr(
