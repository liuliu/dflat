...
public struct zzz_DflatGen_BenchDocV3: FlatBufferObject, Verifiable {
  ...
  public static func createBenchDocV3(
    ...
    zzz_DflatGen_BenchDocV3.add(tag: tag, &fbb)
    zzz_DflatGen_BenchDocV3.add(priority: priority, &fbb)
    zzz_DflatGen_BenchDocV3.add(text: text, &fbb)
